...
BulkDiscount.create(percentage: 0.1, threshold: 2, merchant_id: 1)
BulkDiscount.create(percentage: 0.1, threshold: 4, merchant_id: 2)
BulkDiscount.create(percentage: 0.1, threshold: 2, merchant_id: 3)
BulkDiscount.create(percentage: 0.1, threshold: 4, merchant_id: 4)
BulkDiscount.create(percentage: 0.1, threshold: 3, merchant_id: 5)
BulkDiscount.create(percentage: 0.1, threshold: 4, merchant_id: 6)
BulkDiscount.create(percentage: 0.1, threshold: 2, merchant_id: 7)
BulkDiscount.create(percentage: 0.1, threshold: 4, merchant_id: 8)
BulkDiscount.create(percentage: 0.1, threshold: 3, merchant_id: 9)
BulkDiscount.create(percentage: 0.1, threshold: 4, merchant_id: 10)
BulkDiscount.create(percentage: 0.1, threshold: 2, merchant_id: 11)
BulkDiscount.create(percentage: 0.1, threshold: 4, merchant_id: 12)
BulkDiscount.create(percentage: 0.1, threshold: 2, merchant_id: 13)
